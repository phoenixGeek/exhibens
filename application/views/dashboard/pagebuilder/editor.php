...
<head>
	...
	<link href="assets/pagebuilder/css/editor.css" rel="stylesheet">
	<link href="assets/pagebuilder/css/line-awesome.css" rel="stylesheet">
</head>
...
<body>
		...
		<div id="top-panel">
			...
			<div class="btn-group float-left" role="group">
				<button class="btn btn-light" title="Toggle file manager" id="toggle-file-manager-btn" data-vvveb-action="toggleFileManager" data-toggle="button" aria-pressed="false">
					<img src="assets/pagebuilder/libs/builder/icons/file-manager-layout.svg" width="20px" height="20px">
				</button>
				...
				<button class="btn btn-light" title="Toggle left column" id="toggle-left-column-btn" data-vvveb-action="toggleLeftColumn" data-toggle="button" aria-pressed="false">
					<img src="assets/pagebuilder/libs/builder/icons/left-column-layout.svg" width="20px" height="20px">
				</button>
				...
				<button class="btn btn-light" title="Toggle right column" id="toggle-right-column-btn" data-vvveb-action="toggleRightColumn" data-toggle="button" aria-pressed="false">
					<img src="assets/pagebuilder/libs/builder/icons/right-column-layout.svg" width="20px" height="20px">
				</button>
			</div>
				...
				<div class="header">
					<ul class="nav nav-tabs" id="elements-tabs" role="tablist">
						<li class="nav-item component-tab">
							<a class="nav-link active" id="components-tab" data-toggle="tab" href="#components" role="tab" aria-controls="components" aria-selected="true"><i class="la la-lg la-cube"></i>
								<div><small>Components</small></div>
							</a>
						</li>
						<li class="nav-item blocks-tab">
							<a class="nav-link" id="blocks-tab" data-toggle="tab" href="#blocks" role="tab" aria-controls="blocks" aria-selected="false"><i class="la la-lg la-image"></i>
								<div><small>Blocks</small></div>
							</a>
						</li>
						<li class="nav-item component-properties-tab" style="display:none">
							<a class="nav-link" id="properties-tab" data-toggle="tab" href="#properties" role="tab" aria-controls="blocks" aria-selected="false"><i class="la la-lg la-cog"></i>
					...
					<div id="add-section-box" class="drag-elements">
						...
						<div class="header">
							<ul class="nav nav-tabs" id="box-elements-tabs" role="tablist">
								<li class="nav-item component-tab">
									<a class="nav-link active" id="box-components-tab" data-toggle="tab" href="#box-components" role="tab" aria-controls="components" aria-selected="true"><i class="la la-lg la-cube"></i>
										<div><small>Components</small></div>
									</a>
								</li>
								<li class="nav-item blocks-tab">
									<a class="nav-link" id="box-blocks-tab" data-toggle="tab" href="#box-blocks" role="tab" aria-controls="blocks" aria-selected="false"><i class="la la-lg la-image"></i>
										<div><small>Blocks</small></div>
									</a>
								</li>
								<li class="nav-item component-properties-tab" style="display:none">
									<a class="nav-link" id="box-properties-tab" data-toggle="tab" href="#box-properties" role="tab" aria-controls="blocks" aria-selected="false"><i class="la la-lg la-cog"></i>
										<div><small>Properties</small></div>
									</a>
								</li>
							</ul>
								...
								<div class="col-sm-9 input">
									<div>
										<select class="form-control custom-select" name="startTemplateUrl">
											<option value="assets/pagebuilder/new-page-blank-template.html">Blank Template</option>
											<option value="assets/pagebuilder/demo/narrow-jumbotron/index.html">Narrow jumbotron</option>
											<option value="assets/pagebuilder/demo/album/index.html">Album</option>
										</select>
									</div>
								</div>
							</div>
	...
	<input type="hidden" name="page-id" id="page-id" value="<?= $id ?>">

	<!-- jquery-->
	<script src="assets/pagebuilder/js/jquery.min.js"></script>
	<script src="assets/pagebuilder/js/jquery.hotkeys.js"></script>

	<!-- bootstrap-->
	<script src="assets/pagebuilder/js/popper.min.js"></script>
	<script src="assets/pagebuilder/js/bootstrap.min.js"></script>

	<!-- builder code-->
	<script src="assets/pagebuilder/libs/builder/builder.js"></script>
	<!-- undo manager-->
	<script src="assets/pagebuilder/libs/builder/undo.js"></script>
	<!-- inputs-->
	<script src="assets/pagebuilder/libs/builder/inputs.js"></script>

	<!-- components-->
	<!-- <script src="assets/pagebuilder/libs/builder/components-server.js"></script> -->
	<script src="assets/pagebuilder/libs/builder/components-bootstrap4.js"></script>
	<script src="assets/pagebuilder/libs/builder/components-widgets.js"></script>

	<!-- blocks-->
	<script src="assets/pagebuilder/libs/builder/blocks-bootstrap4.js"></script>

	<!-- plugins -->

	<!-- code mirror - code editor syntax highlight -->
	<link href="assets/pagebuilder/libs/codemirror/lib/codemirror.css" rel="stylesheet" />
	<link href="assets/pagebuilder/libs/codemirror/theme/material.css" rel="stylesheet" />
	<script src="assets/pagebuilder/libs/codemirror/lib/codemirror.js"></script>
	<script src="assets/pagebuilder/libs/codemirror/lib/xml.js"></script>
	<script src="assets/pagebuilder/libs/codemirror/lib/formatting.js"></script>
	<script src="assets/pagebuilder/libs/builder/plugin-codemirror.js"></script>
	<script>
		$(document).ready(function() {
			Vvveb.Builder.init('<?= $content ?>?v=<?= time() ?>', function() {});
			Vvveb.Gui.init();
